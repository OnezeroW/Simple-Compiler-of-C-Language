...
#define STATENUM 133
#define NONENDNUM 33  //非终结符
#define ENDNUM 35//终结符，有个#

#define MAIN 0		//main   *******关键字*******
#define INT 1       //       *******关键字*******
#define IF 2        //       *******关键字*******
#define ELSE 3      //       *******关键字*******
#define WHILE 4     //       *******关键字*******
...
#define postfix_expression 59  //后缀表达式
#define multiplication_expression 60  //乘法
#define additive_expression 61  //加法
#define relational_expression 62  //关系
#define expression 63
#define assignment_expression 64  //赋值
#define string_literal 65
#define declaration 66  //声明
#define init_declarator 67
#define init_declarator_list 68
#define array_initializer 69  //数组
#define initializer_list 70
#define logical_AND_expression 71  //逻辑与
#define logical_OR_expression 72  //逻辑或
